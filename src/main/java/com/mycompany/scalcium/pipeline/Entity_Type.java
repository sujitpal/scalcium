...
public class Entity_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mycompany.scalcium.pipeline.Entity");
  ...
  public String getEntityType(int addr) {
      ...
      jcas.throwFeatMissing("entityType", "com.mycompany.scalcium.pipeline.Entity");
